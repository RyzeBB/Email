	 ...
	 <div class="row col-md-12">
			<form class="form-horizontal" id="editUserForm">
				<div class="form-group">
					<div class="col-sm-2 control-label"><font color="red">*</font>单位税号：</div>
					<div class="col-sm-10">
						<input type="text" name="userName" id="unittax" placeholder="单位税号,作为登陆账号使用,系统人员建议税号和用户名相同" class="form-control dynamicClear required">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2 control-label"><font color="red"></font>单位名称：</div>
					<div class="col-sm-10">
						<input type="text" name="userName" id="unitname" placeholder="单位名称" class="form-control dynamicClear required">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2 control-label"><font color="red">*</font>用户名：</div>
					<div class="col-sm-10">
						<input type="text" name="userName" id="userName" placeholder="用户名" class="form-control dynamicClear required">
					</div>
				</div>
				<div class="form-group">
