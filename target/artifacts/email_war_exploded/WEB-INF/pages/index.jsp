<%@ page  contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" errorPage="/404/index.html"%>
   ...
   <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default cl" data-dismiss="modal">取消</button>
