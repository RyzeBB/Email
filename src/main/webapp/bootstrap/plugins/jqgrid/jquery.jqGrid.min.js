...
j,k,l=[],m={};l.push("Grid Options"),l.push(f),l.push(""),l.push("GridData"),l.push(g),m.type="plain/text;charset=utf-8";try{j=new
...
c=$.extend({xmlDecl:'<?xml version="1.0" encoding="UTF-8" ?>',attr_prefix:"-",encode:!0},b||{}),d=this,e=function(a,b){return"#text"===a?c.encode?d.encode(b):b:"function"==typeof
b?"<"+a+"><![CDATA["+b+"]]></"+a+">":""===b?"<"+a+">__EMPTY_STRING_</"+a+">":"<"+a+">"+(c.encode?d.encode(b):b)+"</"+a+">"},f=function(a,b){for(var
...
h?c[c.length]=g(a,h):c[c.length]=e(a,h)}return c.length||(c[0]="<"+a+">__EMPTY_ARRAY_</"+a+">"),c.join("")},g=function(a,b){var
h=[],i=[];for(var
j
in
